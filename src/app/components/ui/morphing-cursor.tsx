...
export function MagneticText({ text = "CREATIVE", hoverText = "EXPLORE", className, textClassName }: MagneticTextProps) {
  ...
  return (
    ...
    >
      ...
      <div
        ref={circleRef}
        className="absolute top-0 left-0 pointer-events-none rounded-full bg-[#DFE104] overflow-hidden"
        style={{
      ...
      >
        ...
        >
          <span className={cn("text-5xl font-bold tracking-tighter text-black whitespace-nowrap tracking-wide", textClassName)}>
            {hoverText}
          </span>
        </div>
      </div>
