    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="py-32 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-5xl md:text-7xl lg:text-8xl mb-20 text-center">
            HOW IT <span className="text-[#DFE104]">WORKS</span>
          </h2>
          ...
          <div className="grid md:grid-cols-3 gap-px bg-[#3F3F46]">
            ...
            <div className="bg-background p-12 group hover:bg-[#DFE104] transition-all duration-300">
              <div className="text-[8rem] md:text-[10rem] font-bold leading-none mb-6 text-[#DFE104] group-hover:text-black transition-colors">
                01
              </div>
      ...
      <section className="py-32 px-4 border-t-2 border-[#3F3F46] bg-muted">
        <div className="max-w-6xl mx-auto text-center">
          <div className="mb-12 cursor-none">
            <MagneticText 
              text="SAVE LIVES" 
              hoverText="JOIN US" 
              textClassName="text-5xl md:text-7xl lg:text-9xl leading-[0.8] tracking-tighter"
            />
          </div>
